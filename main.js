...
const AME_f_qry =
  "SELECT * FROM africa_middleeast_fate ORDER BY africa_fate_id ASC";
...
const AME_emit_qry =
  "SELECT * FROM africa_middleeast_emit_ocean ORDER BY africa_eo_id ASC";
const Amer_emit_qry =
  "SELECT * FROM americas_emit_ocean ORDER BY americas_eo_id ASC";
const Asia_emit_qry = "SELECT * FROM asia_emit_ocean ORDER BY asia_eo_id ASC";
const Euro_emit_qry =
  "SELECT * FROM europa_emit_ocean ORDER BY europa_eo_id ASC";
const Ocea_emit_qry =
  "SELECT * FROM oceania_emit_ocean ORDER BY oceania_eo_id ASC";

const global_plastic_qry =
  "SELECT * FROM global_plastic_production ORDER BY gpo_id ASC";
