...
// Der oprettes en sti-generator, der angiver den geografiske projektion ved hjælp af den tidligere defineret Mercator-projektion
  ...
  Promise.all([
        ...
        .on("mouseover", function (event, d) {
            ...
            d3.selectAll(`.continent[continentFile="${continent}"] path`)
              ...
              .attrTween("stroke-width", function () {
                ...
                const interpolate = d3.interpolate(initialStrokeWidth, targetStrokeWidth);
    ...
    function showWelcomeText(continent) {
        ...
        currentWelcomeText = welcomeContainer.append("div")
            .attr("class", "welcome-text");
    
        if (continent) {
            currentWelcomeText.text(`${kontinent[continent]} håndtering af plastik affald`);
        } else {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const labelTextMap = {
    'Americas_eo': 'Lande i Amerika og deres andel af plastikforurening i havene, målt i procent',
    'Asia_eo': 'Lande i Asien og deres andel af plastikforurening i havene, målt i procent',
    'Europe_eo': 'Lande i Europa og deres andel af plastikforurening i havene, målt i procent',
    'Oceania_eo': 'Lande i Oceanien og deres andel af plastikforurening i havene, målt i procent',
    'Africa_eo': 'Lande i Afrika og deres andel af plastikforurening i havene, målt i procent'
  };
